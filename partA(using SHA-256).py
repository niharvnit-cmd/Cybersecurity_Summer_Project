...
def modify_string(original_string):
    ...
    while True:
        # Choose from printable ASCII characters (32-126)
...
def main():
    print("Product Identity Hash Verifier")
    print("=" * 40)
    ...
    if original_hash == modified_hash:
        print(
            ...
            "This is extremely unlikely with SHA-256."
        )
        ...
        print("   This demonstrates the avalanche effect of SHA-256.")
